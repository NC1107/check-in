...
// location read, the two clip operations no Flutter package covers. Runs the work off the
// platform thread so a multi-second remux never blocks the UI, then hands the result back
// on the main thread the channel requires.
